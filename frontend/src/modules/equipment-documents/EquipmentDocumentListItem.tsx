    ...
    >
      ...
      <div className="equipment-document-actions">
        <button
          ...
          aria-label={downloadingFileId === file.id ? text.downloading : text.download}
          onClick={(event) => {
            event.stopPropagation();
            onDownload(file);
          }}
          title={downloadingFileId === file.id ? text.downloading : text.download}
          type="button"
        >
        ...
        {mode === "edit" ? (
          <button
            ...
            aria-label={deletingFileId === file.id ? text.deleting : text.delete}
            onClick={(event) => {
              event.stopPropagation();
              onDelete(file);
            }}
